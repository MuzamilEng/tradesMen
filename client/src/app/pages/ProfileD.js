...
import PinLocation from '../Component/GoogleMap/PinLocation'
...
<div role="status">
  ...
  return (
    ...
    <div className='w-full flex'>
      <img src={data?.image ? data?.image : '/img/man.png'} alt={data?.username} className='rounded-full shadow-xl w-full max-w-[10vw] h-[10vw]'/>
     
    <div className='ml-[1vw]'>
    <p className='font-bold text-[1.2vw]'>{data?.username}</p>
    <p>{data?.occupation}</p>
    <p className='flex items-center'><Icon icon="gg:phone" />{'0'+ data?.phoneNumber}</p>
